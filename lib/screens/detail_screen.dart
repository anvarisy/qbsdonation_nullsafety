...
class detail extends State<detail_screen> {
                    ...
                    children: <Widget>[
                      ...
                      Expanded(
                        child: Padding(
                          ...
                          child: Container(),
                          // TODO: do open_ticket
                          //open_ticket(isScrollable: false,mFavouriteList: tickets,m: widget.m,profil: widget.profil,),
                        ),
                      )
                    ],
                  ),
  ...
  Widget _Collected(BuildContext context, List<QueryDocumentSnapshot> snapshot){
    double total = 0;
    for(QueryDocumentSnapshot element in snapshot){
      var data = element.data();
      if(data['gross_amount']!=null){
        total+=double.parse(data['gross_amount']);
      }
    }
    return Container(
      child: Column(
              ...
              InkWell(
                ...
                child:  RichText(
                  text: TextSpan(
                    children: [
                      TextSpan(
                          text: money.toCurrency(widget.m.target as String),
                          style: TextStyle(
                              fontSize: textSizeMedium,
                              fontFamily: fontMedium,
                              color: t10_textColorSecondary)),
              ...
              InkWell(
                ...
                child:  RichText(
                  text: TextSpan(
                    children: [
                      TextSpan(
                          text: money.toCurrency(total.toString()),
                          style: TextStyle(
                              fontSize: textSizeMedium,
                              fontFamily: fontMedium,
                              color: t10_textColorSecondary)),
  ...
  Future<void> showPengaduan() async {
