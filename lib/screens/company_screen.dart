...
class company extends State<company_screen> {
  ...
  Widget BuildCompany(BuildContext context){
   return FutureBuilder<QuerySnapshot>(
       future: FirebaseFirestore.instance.collection('Profil').get(),
       builder: (context, snapshot) {
         return !snapshot.hasData
             ? Container()
             : _Company(context, snapshot.data!.docs);
       },);
  }

  Widget _Company(BuildContext context, List<QueryDocumentSnapshot> snapshot){
    String misi = '<ol>';
