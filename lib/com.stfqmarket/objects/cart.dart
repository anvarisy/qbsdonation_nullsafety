...
class Cart {
  ...
  final String tenantId, tenantName, status, tenantCityCode;
  final String? resiOrder;
  final CartUser user;
  ...
  static Cart toCart(QueryDocumentSnapshot e) {
    var user = e.data()['user'];

    return Cart(
        e.id, e.data()['order_id'],
  ...
  static List<Cart> toList(List<QueryDocumentSnapshot> items) {
    List<Cart> carts = [];
